...
public class UF_HWQUPC implements UF {
    ...
    //takes n as the argument and return the number of connections.
    public static int count(int n) {
        ...
        while (uf.components() != 1) {
            ...
            //ensure first is connected to the second
    ...
    public static void main(String[] args) {
        ...
        int m = 100; // run the count function m times
        ...
        for (int i = 0; i < n.length; i++) {
            ...
            System.out.println("sites: " + n[i] + " the mean number of connections generated: " + result +
                    " after running: " + m + " times." + " Expected relationship: " +  0.5 * n[i]* Math.log(n[i]) +
                    " ratio: " + result / (0.5 * n[i]* Math.log(n[i]))) ;
        }
    }
}
